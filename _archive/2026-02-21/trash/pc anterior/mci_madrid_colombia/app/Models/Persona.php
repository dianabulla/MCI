...
class Persona extends BaseModel {
    ...
    public function getById($id) {
        $sql = "SELECT p.*, 
                ...
                r.Nombre_Rol, 
                m.Nombre_Ministerio,
                CONCAT(inv.Nombre, ' ', inv.Apellido) AS Nombre_Invitador,
                ...
                LEFT JOIN persona inv ON p.Invitado_Por = inv.Id_Persona
    ...
    /**
     * Obtener personas con rol Líder o Pastor
     */
    public function getLideresYPastores() {
        $sql = "SELECT * FROM {$this->table} WHERE Id_Rol IN (1, 2) ORDER BY Apellido, Nombre";
        return $this->query($sql);
    }
